...
function InstructorDashboard({ listOfCourses }) {
  ...
  function calculateTotalStudentsAndProfit() {
    const { totalStudents, totalProfit, studentList } = listOfCourses.reduce(
      (acc, course) => {
        ...
        console.log("total students", acc.totalStudents);
      ...
      // intial value: during each iteration acc gets updated with values from the current course:
      {
        totalStudents: 0,
        totalProfit: 0,
        studentList: [],
  ...
  console.log("studentsprofit", calculateTotalStudentsAndProfit());
